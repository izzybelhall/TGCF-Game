document.addEventListener('DOMContentLoaded', function () {
	...
	function checkDiceResult() {
	  ...
	  if (diceResult === 1 || diceResult === 6) {
		...
		alert("You rolled a " + diceResult + "! Hua Cheng grants you luck and safe passage.");
	  } else {
		alert("You rolled a " + diceResult + ". Luck is not on your side. Use your saved luck or face your fears.");
	  }
